...
function M._load(options)
	...
	M.defaults = {
		...
		['DiagnosticHint'] = { fg = p.shade3 },
		['DiagnosticVirtualTextHint'] = { fg = p.bg, bg = p.shade3 },
		['DiagnosticWarn'] = { fg = p.warn },
		['DiagnosticVirtualTextWarn'] = { fg = p.bg, bg = p.warn },
		['DiagnosticInfo'] = { fg = p.info },
		['DiagnosticVirtualTextInfo'] = { fg = p.bg, bg = p.info },
		-- GitSigns
